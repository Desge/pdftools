...
const dict: LangDict = {
  ...
  workspace: {
    ...
    previewWarning: "Modalità anteprima. Alcune azioni possono essere limitate in questa versione basata sul browser.",
    selectHint: "Seleziona i file sopra per iniziare.",
    comingSoon: "Questo strumento non è disponibile nella versione browser. Scegli uno strumento PDF disponibile dall’elenco.",
    pages: "pagine",
    mb: "MB",
    kb: "KB",
  ...
  convert: {
    ...
    comingSoon: "Conversione non supportata",
    comingSoonDesc: "Questo tipo di conversione richiede elaborazione lato server e non è disponibile in questa versione browser.",
...
pages: {
  pricing: {
    ...
    proTier: "Pro",
    proDesc: "Le funzionalità avanzate per utenti esperti non fanno parte della versione gratuita del browser.",
    ocrNote: "L’OCR (riconoscimento ottico dei caratteri) richiede elaborazione server e non è incluso nella versione gratuita del browser.",
