...
const dict: LangDict = {
  ...
  workspace: {
    ...
    previewWarning: "Vorschaumodus. Einige Aktionen können in dieser browserbasierten Version eingeschränkt sein.",
    selectHint: "Wählen Sie oben Dateien aus, um zu starten.",
    comingSoon: "Dieses Tool ist in der Browserversion nicht verfügbar. Wählen Sie ein verfügbares PDF-Tool aus der Liste.",
    pages: "Seiten",
    mb: "MB",
    kb: "KB",
  ...
  convert: {
    ...
    comingSoon: "Nicht unterstützte Konvertierung",
    comingSoonDesc: "Dieser Konvertierungstyp erfordert serverseitige Verarbeitung und ist in dieser Browserversion nicht verfügbar.",
...
pages: {
  pricing: {
    ...
    proTier: "Pro",
    proDesc: "Erweiterte Funktionen für Power-User sind nicht Teil der kostenlosen Browserversion.",
    ocrNote: "OCR (optische Zeichenerkennung) erfordert serverseitige Verarbeitung und ist nicht in der kostenlosen Browserversion enthalten.",
