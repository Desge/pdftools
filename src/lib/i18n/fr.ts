...
pages: {
  pricing: {
    ...
    proTier: "Pro (Bientôt disponible)",
    proDesc: "Fonctionnalités avancées pour les utilisateurs qui ont besoin de plus. Restez à l'écoute !",
    ocrNote: "La ROC (Reconnaissance Optique de Caractères) sera disponible en tant que fonctionnalité Pro. Convertissez les PDF scannés en texte consultable avec une précision professionnelle.",
