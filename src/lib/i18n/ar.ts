...
pages: {
  pricing: {
    ...
    proTier: "احترافي (قريباً)",
    proDesc: "ميزات متقدمة للمستخدمين الذين يحتاجون المزيد. ترقبوا!",
    ocrNote: "التعرف البصري على الأحرف (OCR) سيكون متاحاً كميزة احترافية. حوّل ملفات PDF الممسوحة ضوئياً إلى نص قابل للبحث بدقة احترافية.",
